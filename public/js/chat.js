...
function create_each_block(ctx) {
  ...
  return {
    c: function c() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.attr)(div, "class", div_class_value = "message " + (
      /*message*/
      ctx[4].from === 'me' ? 'bg-blue-100 text-right' : 'bg-red-100') + " p-2 mb-3 rounded-lg");
    },
    m: function m(target, anchor) {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.append)(div, t1);
    },
    p: function p(ctx, dirty) {
      ...
      2 && t0_value !== (t0_value =
      /*message*/
      ctx[4].text + "")) (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.set_data)(t0, t0_value);

      if (dirty &
      /*messages*/
      2 && div_class_value !== (div_class_value = "message " + (
      /*message*/
      ctx[4].from === 'me' ? 'bg-blue-100 text-right' : 'bg-red-100') + " p-2 mb-3 rounded-lg")) {
        (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.attr)(div, "class", div_class_value);
      }
    },
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.attr)(div0, "class", "chat-space flex-col");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.attr)(input, "type", "text");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.attr)(input, "class", "border-2 border-gray-400 w-full p-1");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.attr)(div1, "class", "border border-gray-200 bg-white p-2 rounded-lg mb-4");
    },
    m: function m(target, anchor) {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.append)(div1, t);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.append)(div1, form);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.append)(form, input);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.set_input_value)(input,
      /*text*/
      ctx[0]);

      if (!mounted) {
        dispose = [(0,svelte_internal__WEBPACK_IMPORTED_MODULE_1__.listen)(input, "input",
        /*input_input_handler*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  function handleForm(_x) {
    return _handleForm.apply(this, arguments);
  }

  function _handleForm() {
    _handleForm = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(event) {
      var message;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              $$invalidate(1, messages = [].concat(_toConsumableArray(messages), [message]));
              $$invalidate(0, text = '');
  ...
  return [text, messages, handleForm, input_input_handler];
}
